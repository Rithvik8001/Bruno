...
export const type = {
  ...
  stat: { fontFamily: fonts.sansMedium, fontSize: 20, lineHeight: 24, letterSpacing: -0.3 },
  row: { fontFamily: fonts.sansMedium, fontSize: 16, lineHeight: 20, letterSpacing: 0 },
  ...
  filter: { fontFamily: fonts.sansMedium, fontSize: 15, lineHeight: 20, letterSpacing: 0 },
  caption: { fontFamily: fonts.sans, fontSize: 13, lineHeight: 18, letterSpacing: 0 },
  sub: { fontFamily: fonts.sans, fontSize: 12, lineHeight: 14, letterSpacing: 0 },
  label: {
